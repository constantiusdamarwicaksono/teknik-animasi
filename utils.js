...
window.utils.drawBounds=function(context,object){
       context.save();
       context.beginPath();
...
window.utils.drawBoundsBall=function(context,object){
       context.save();
       context.beginPath();
...
window.utils.drawCircle=function(context,x,y,radius,color){
      context.beginPath();
